...
- **Continuous recording** — optional always-on recording per camera, off by default, requires external storage
...
- **Camera health alerts** — notified if a camera goes offline or comes back, off by default
